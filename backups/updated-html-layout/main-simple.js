...
class AudioWaveformPlayerComponent extends Component {
	...
	onunload() {
		...
		// Clean up speed slider dragging event listeners
		document.removeEventListener('mousemove', this.speedSliderMouseMoveHandler);
		document.removeEventListener('mouseup', this.speedSliderMouseUpHandler);
	}
}
